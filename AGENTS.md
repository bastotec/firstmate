...
Once custody is settled, or once the worker has reported its final `done:`, getting the branch current is yours to own by steering or relaunching the worker, never by running a rebase in its worktree yourself.
