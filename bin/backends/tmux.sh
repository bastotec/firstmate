...
# clears. See bin/fm-tmux-lib.sh for the composer-verification contract and
# echoed verdicts.
fm_backend_tmux_send_text_submit() {  # <target> <text> <retries> <enter-sleep> <settle> [expected-label] [harness] [state-dir] [task-id]
