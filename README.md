...
- [docs/voice-relay.md](docs/voice-relay.md) - the optional spoken interface: setup on both machines or the wake-word HUD overlay on the Mac, measured round-trip cost, what a spoken answer may read, and what this build does not do yet.
