...
deck is likewise verified for crewmate and scout launches ONLY, refused for a secondmate because its pane driver supervises one task rather than a home; [`docs/verification/deck.md`](verification/deck.md) owns the live evidence and driver contract.
