...
Because the step decides what to run, `test.instructions` holds it to that targeted validation and names the live-rig building a lifecycle change would otherwise invite.
