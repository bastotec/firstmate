...
Because the step decides what to run, `test.instructions` points it at the suites under `tests/` as this product's live rig and rules out the additional rig-building a lifecycle change would otherwise invite.
