...
| `fm-retire-endpoint.sh`  | Operator-only: retire the durable records of named tasks whose endpoint no backend can answer for, recording who asserted it and when |
