...
The host regression forces actionable watcher exits across long handling turns and proves each successor starts while Deck turns remain serialized, with accumulated wakes delivered by the next turn.
