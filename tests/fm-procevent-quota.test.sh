...
if err=$(QUOTA_AXI_VERSION='quota-axi development build 2026.09.19' PATH="$FAKEBIN:$PATH" \
...
out=$(QUOTA_AXI_VERSION='quota-axi development build 2026.09.19' QUOTA_AXI_COUNT="$COUNT" PATH="$FAKEBIN:$PATH" \
